 ...
 */
public class RealPatrolViewModel implements PatrolViewModel {
     ...
     */
    @Inject
    public RealPatrolViewModel(final PatrolDAO patrolDAO) {
     ...
     */
    public RealPatrolViewModel setSquadrons(final SquadronsViewModel squadronsViewModel) {
     ...
     * @return This patrol view model.
     */
    public RealPatrolViewModel setModel(final Patrol patrolModel) {
