 ...
 */
@Slf4j
public class RealAirbaseViewModel implements Comparable<AirbaseViewModel>, AirbaseViewModel {
    ...
    private final Provider<RealPatrolViewModel> patrolViewModelProvider;
     ...
     */
    @Inject
    public RealAirbaseViewModel(final Provider<NationAirbaseViewModel> nationAirbaseViewModelProvider,
                                final Provider<AirMissionViewModel> missionViewModelProvider,
                                final Provider<RealPatrolViewModel> patrolViewModelProvider,
     ...
     */
    public RealAirbaseViewModel setModel(final Airbase base) {
     ...
     * @return This airbase view model.
     */
    public RealAirbaseViewModel setGroup(final AirbaseGroupViewModel group) {
        airbaseGroup = group;
        return this;
    }
     ...
     */
    public void save() {
        log.info("Save airbase: '{}", airbase.getValue().getTitle());
        ...
        patrolViewModels.values().forEach(PatrolViewModel::save);              // Save the edited patrols.
    }
