...
public class VirtualPatrolViewModel implements PatrolViewModel {
    @Getter
    private final ListProperty<SquadronViewModel> assignedAllNations = new SimpleListProperty<>();   // All nation's squadrons on patrol. Written to model.
     ...
     */
    @Inject
    public VirtualPatrolViewModel(final PatrolDAO patrolDAO) {
     ...
     */
    public VirtualPatrolViewModel setSquadrons(final SquadronsViewModel squadronsViewModel) {
     ...
     * @return This patrol view model.
     */
    public VirtualPatrolViewModel setModel(final Patrol patrolModel) {
