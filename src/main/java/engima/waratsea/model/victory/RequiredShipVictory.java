 ...
 */
@Slf4j
public class RequiredShipVictory implements VictoryCondition {
     ...
     */
    @Inject
    public RequiredShipVictory(@Assisted final RequiredShipVictoryData data,
     ...
     */
    public void match(final ShipEvent event) {
