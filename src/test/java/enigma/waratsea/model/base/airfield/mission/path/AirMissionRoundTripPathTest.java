...
@Slf4j
public class AirMissionRoundTripPathTest {
    ...
    public void testAddInBound() {
        ...
        List<GameGrid> fullPath = Deencapsulation.invoke(path, "addInBound", outBound);
    ...
    public void testProgress() {
        ...
        List<GameGrid> fullPath = new ArrayList<>(Arrays.asList(
                ...
                new GameGrid(0,1),
                new GameGrid(0,2),
                new GameGrid(0,1),     // In this test the first progress moves the index here.
                new GameGrid(0, 0)));  // In this test the second progress moves the index here.
